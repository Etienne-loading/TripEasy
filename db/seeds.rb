...
like1 = { user: User.all.sample, blog: Blog.last }
325.times do
  like = Like.create!(
    user: like1[:user],
    blog: like1[:blog]
...
argentine = {
  title: "Thrilling Explorations in Argentina",
  min_price: rand(2000..2500),
  max_price: rand(2500..2800),
  start_date: "2023-01-01",
  end_date: "2023-01-30",
  carbon_friendly: true,
  user: User.all.sample,
  intro: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
  url: "https://images.unsplash.com/photo-1615657071655-3748ccc3340c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2832&q=80"
}

india = {
  title: "Enchanting India: Embark on a Journey",
  min_price: rand(1000..1100),
  max_price: rand(1400..1800),
  start_date: "2023-04-01",
  end_date: "2023-04-30",
  carbon_friendly: true,
  user: User.all.sample,
  intro: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
  url: "https://images.unsplash.com/photo-1524492412937-b28074a5d7da?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2942&q=80"
}
...
[india].each do |hash|
  ...
  step1 = { title: "Step 1", country: "India", blog: Blog.last }
  [step1].each do |step_hash|
    step = Step.create!(
      title: step_hash[:title],
      country: step_hash[:country],
...
[argentine].each do |hash|
  ...
  step1 = { title: "Step 1", country: "Argentine", blog: Blog.last }
  [step1].each do |step_hash|
    step = Step.create!(
      title: step_hash[:title],
      country: step_hash[:country],
...
30.times do
  ...
  start_date = Faker::Date.between(from: '2022-01-01', to: '2022-06-30').to_s
  end_date = Faker::Date.between(from: '2022-07-05', to: '2022-12-31').to_s
  carbon_friendly = true
  user = User.all.sample
...
japan = {
  title: "Japan: country of culture",
  min_price: 5000,
  max_price: 8000,
  ...
  carbon_friendly: true,
  user: User.last,
  intro: "Welcome to our blog dedicated to Japanese culture! Immerse yourself in a world rich with ancient traditions, exquisite arts, and captivating landscapes. Discover the mysteries of tea ceremonies, delve into the secrets of the samurai, appreciate the beauty of haiku poetry, and much more. Allow yourself to be enchanted by the magic of Japan as you explore its unique cultural treasures. Konnichiwa!" }
...
[japan].each do |hash|
  ...
  image = URI.open("https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2340&q=80")
  blog.photo_banner.attach(io: image, filename: blog.title, content_type: 'png')
  image = URI.open("https://images.unsplash.com/photo-1492571350019-22de08371fd3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2853&q=80")
  blog.photo_card.attach(io: image, filename: blog.title, content_type: 'png')
  blog.save
...
step1 = { title: "Tokyo: heart of Japan",
  address: "Tokyo",
  duration: 7,
  layout: 1,
  blog: Blog.last,
...
step2 = { title: "Discovering the old city of Tokyo",
  address: "Tokyo",
  content: "Immerse yourself in the heart of this captivating capital where tradition and modernity seamlessly blend. Explore bustling neighborhoods like Shibuya and Shinjuku, where skyscrapers compete with dazzling neon lights. Immerse yourself in Japanese culture by visiting ancient temples like Senso-ji in Asakusa. Indulge in delicious food at Tsukiji's street food stalls or savor exceptional sushi at renowned restaurants. Discover tranquil gardens such as the beautiful Shinjuku Gyoen or witness the futuristic wonders of Akihabara's electronic district.",
  duration: 4,
  latitude: 35.6895,
  longitude: 139.6917,
  country: "Japan",
  blog:Blog.last,
  url: "https://images.unsplash.com/photo-1573455494060-c5595004fb6c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1680&q=80",
  layout: 2 }
step3 = { title: "Amazing local food",
  address: "Tokyo",
  duration: 3,
  latitude: 35.6895,
  longitude: 139.6917,
  country: "Japan",
  blog:Blog.last,
  url:"https://images.unsplash.com/photo-1614563637806-1d0e645e0940?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1546&q=80",
  content:"Japan's local cuisine is a delightful blend of flavors, traditions, and artistry. From fresh sushi and sashimi to savory ramen and crispy tempura, Japanese cuisine is a feast for the senses. Indulge in melt-in-your-mouth wagyu beef, delicate tofu dishes, and comforting bowls of steaming udon noodles. Don't miss the chance to try street food favorites like takoyaki and yakitori. Immerse yourself in the world of Japanese tea ceremonies and taste authentic matcha desserts. With its emphasis on quality, presentation, and unique ingredients, Japan's local food scene is a culinary adventure like no other.", layout: 2 }
step4 = {
    title: "Reflection and Resilience in Hiroshima",
    address: "Hiroshima",
    duration: 7,
    latitude: 34.3853,
    longitude: 132.4553,
...
step5 = { title: "City of peace", address: "Hiroshima",
          content: "Journey to Hiroshima, a city with a profound history. Pay your respects at the Hiroshima Peace Memorial Park and Museum, learn about the tragic events of the atomic bombing, and appreciate the city's commitment to peace and reconciliation. Explore the picturesque Miyajima Island with its iconic floating torii gate and serene temples. Witness the vibrant cherry blossoms in spring or the fiery hues of autumn in Hiroshima's beautiful gardens.",
          duration: "7",
          latitude: 34.3853,
          longitude: 132.4553,
          country: "Japan",
...
step7 = {
  title: "Nature's Wonderland: Exploring Hokkaido's Beauty",
  address: "Hokkaido",
  content: "Venture to the northernmost island of Japan, Hokkaido, known for its stunning natural landscapes. Discover the breathtaking beauty of national parks like Shiretoko and Daisetsuzan, soak in natural hot springs, and experience the unique wildlife, including the iconic red-crowned cranes. Enjoy outdoor activities such as hiking, skiing, and exploring the charming cities of Sapporo and Otaru.",
  duration: "6",
  latitude: 43.2203,
  longitude: 142.8635,
  country: "Japan",
  blog: Blog.last,
  url: "https://images.unsplash.com/photo-1629725593792-727bbe2255b2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2340&q=80",
  layout: 2 }
